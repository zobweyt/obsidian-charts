...
- Ensure the [bases core plugin](https://help.obsidian.md/bases) is installed and enabled in your settings.
...
2. Open the **View Settings** to configure the **X-Axis** and select the property you want to use as a category ([`Text`](https://obsidian.md/help/properties#Text), [`Number`](https://obsidian.md/help/properties#Number), or [`Date`](https://obsidian.md/help/properties#Date) supported).
3. Open the [properties](https://obsidian.md/help/properties) menu in the top-right corner of the base to select the data for **Y-Axis** to be used as values (only [`Number`](https://help.obsidian.md/bases/functions) is supported).
